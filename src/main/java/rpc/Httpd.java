...
public class Httpd {
    ...
    public static void run(final KafkaStreams streams) throws Exception {
        Thread t = new RequestListenerThread(8088, "service", streams);
        t.setDaemon(false);
        t.start();
    }
    ...
    static class HttpFileHandler implements HttpRequestHandler {
        ...
        private KafkaStateHandler kafkaStateHandler;

        public HttpFileHandler(final String docRoot, final KafkaStreams streams) {
            super();
            this.docRoot = docRoot;
            this.kafkaStateHandler = new KafkaStateHandler(streams);
        }
        ...
        private String thriftRequest(byte[] input){
            try{
                ...
                TProcessor processor = new KakfaStateService.Processor(this.kafkaStateHandler);
    ...
    static class RequestListenerThread extends Thread {
        ...
        public RequestListenerThread(int port, final String docroot, final KafkaStreams streams) throws IOException {
            ...
            reqistry.register("*", new HttpFileHandler(docroot, streams));
